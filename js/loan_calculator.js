...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (toggleBtn) {
        toggleBtn.addEventListener('click', function() {
            ...
            this.textContent = isHidden ? 'Hide Advanced Options' : 'Show Advanced Options (Early Payments)';
        });
    }
...
// Combined page version of calculateLoan
function calculateLoanCombined() {
    try {
        const principal = parseFloat(document.getElementById('loan_amount').value);
        const annualRate = parseFloat(document.getElementById('interest_rate').value);
        const termMonths = parseInt(document.getElementById('loan_term').value);
...
// Combined page version of calculateAdvancedLoan
function calculateAdvancedLoanCombined() {
    try {
        const principal = parseFloat(document.getElementById('loan_amount').value);
        const annualRate = parseFloat(document.getElementById('interest_rate').value);
        const termMonths = parseInt(document.getElementById('loan_term').value);
