...
export function calculateAdvancedSalary() {
    try {
        ...
        if (!outputDiv) {
            ...
            document.querySelector('form').insertAdjacentElement(
                'afterend',
                outputDiv
            );
        }
...

            {
                ...
                rows: [
                    ...(housingCompensation > 0
                        ? [{
                            label: 'Housing',
                            value: housingCompensation.toFixed(3),
                            positive: true
                        }]
                        : []),
                    ...
                    ...(salaryAddition > 0
                        ? [{
                            ...
                            value: salaryAddition.toFixed(3),
                            positive: true
                        }]
                        : []),
